...
export const api = {
  ...
  riskBreakdown: (id) => request(`/customers/${id}/risk-breakdown`),
  notes: (id) => request(`/customers/${id}/notes`),
  addNote: (id, payload) => request(`/customers/${id}/notes`, { method: "POST", body: payload }),
  deleteNote: (id, nid) => request(`/customers/${id}/notes/${nid}`, { method: "DELETE" }),
  ...
  riskMethodologyOptions: () => request("/risk/methodology-options"),
  createRiskMethodology: (payload) => request("/risk/methodologies", { method: "POST", body: payload }),
  renameRiskMethodology: (mid, name) => request(`/risk/methodologies/${mid}`, { method: "PATCH", body: { name } }),
  deleteRiskMethodology: (mid) => request(`/risk/methodologies/${mid}`, { method: "DELETE" }),
  addRiskFactor: (mid, payload) => request(`/risk/methodologies/${mid}/factors`, { method: "POST", body: payload }),
  updateRiskFactor: (fid, payload) => request(`/risk/factors/${fid}`, { method: "PATCH", body: payload }),
  deleteRiskFactor: (fid) => request(`/risk/factors/${fid}`, { method: "DELETE" }),
  setRiskThresholds: (mid, thresholds) => request(`/risk/methodologies/${mid}/thresholds`, { method: "PUT", body: { thresholds } }),
  activateRiskMethodology: (mid) => request(`/risk/methodologies/${mid}/activate`, { method: "POST" }),
