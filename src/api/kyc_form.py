...
FORM_SECTIONS = [
    ...
    },
    {
        ...
        "fields": [
            ...
            _f("principal_place_of_business_country", "Country of the principal place of business",
               "country", category="ADDRESS",
    ...
    },
    {
        ...
        "fields": [
            _f("business_activity", "Main business activity", "activity",
               required=True, category="BUSINESS",
               help="Closed catalogue — each category carries a risk weight."),
            _f("business_activity_detail", "Describe the activity", "textarea",
               category="BUSINESS", help="What the company actually does, in its own words."),
            _f("industry_sector", "Industry / sector", category="BUSINESS"),
            _f("nace_code", "NACE / SIC code", category="BUSINESS",
               help="A NACE Rev. 2 code (e.g. 64.19) pre-selects the activity category."),
